...
public class DBManager {
    ...
    public void addProduct(int ProductID, String ProductName, int StockLevel, double UnitPrice, String Category) throws SQLException { //code for add-operation
       st.executeUpdate("INSERT INTO App.Products " + "VALUES (" + ProductID + ",'"+ProductName +"'," + StockLevel +"," + UnitPrice + ",'" + Category + "')" );    
    }
