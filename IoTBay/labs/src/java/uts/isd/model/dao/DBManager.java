...
public class DBManager {
    ...
    public void addProduct(Integer ProductID, String ProductName, String StockLevel, Integer UnitPrice, String Category) throws SQLException { //code for add-operation
